...
Вид приложения имеет в начале [главное окно](), в котором содержатся переходы на все остальные окна и элементы графиского интерфейса пользователя: 
1. [диалоговое окно открытия файла]() (системное окно, предоставляет доступ к файловой системе, и затем открывает нужный файл).
2. [управление цветом картинки для видео]() (управляет уровнями яркости, контрастности, оттенка и насыщенности изображения).
